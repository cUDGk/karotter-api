...
[
  {
    ...
    "condition": {
      "regexFilter": "https://karotter\.com/assets/Admin-[a-zA-Z0-9]{8}\.js",
...
- **チャンクハッシュはデプロイ毎に変わる** — `rules.json` は `regexFilter` でパターンマッチするため更新不要。ただし `admin.js` のimportパスは都度更新する必要がある
